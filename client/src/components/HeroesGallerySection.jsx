...
import wayangKiri from '../assets/heroes/wayang-kiri.png';
import wayangKanan from '../assets/heroes/wayang-kanan.png';
  ...
  return (
    <section className="relative w-full bg-bianca-50 font-teachers flex flex-col items-center pt-32 z-10 overflow-hidden">
      ...
      <div data-aos="fade-up" className="w-full flex justify-center items-center gap-2 md:gap-3 mb-24 relative z-10">
        ...
        <button className="w-9 h-9 md:w-11 md:h-11 rounded-lg bg-[#b5a38f]/40 hover:bg-[#b5a38f]/70 text-inv-base font-bold text-sm md:text-base transition">1</button>
        <button className="w-9 h-9 md:w-11 md:h-11 rounded-lg bg-inv-base text-white shadow-md font-bold text-sm md:text-base transition">2</button>
