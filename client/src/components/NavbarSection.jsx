    ...
    <nav className={navClasses}>
      <div className="flex justify-between items-center px-6 md:px-16 transition-all duration-300">
        ...
        <ul className={`hidden md:flex items-center gap-8 font-teachers text-sm md:text-base font-medium ${textClasses}`}>
          <li className="cursor-pointer hover:text-inv-accent transition"><Link to="/">Home</Link></li>
          
          {/* MENU EXPLORE */}
          <li className="relative group cursor-pointer py-4">
            <div className="flex items-center gap-1.5 hover:text-inv-accent transition">
          ...
          <li className="cursor-pointer hover:text-inv-accent transition"><Link to="/ai-assistant">AI Assistant</Link></li>
          <li className="cursor-pointer hover:text-inv-accent transition"><Link to="/insights">Insights</Link></li>
        </ul>

        {/* --- TOMBOL HAMBURGER --- */}
        <button 
          className={`md:hidden text-2xl p-2 focus:outline-none hover:text-inv-accent transition ${textClasses}`}
